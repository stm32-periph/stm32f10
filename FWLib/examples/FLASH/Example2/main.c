...
int main(void)
{
  ...
  if (ProtectedPages != 0x00)
  {/* Pages 24 to 31 not write protected */

    /* Enable the write protection of pages 24 to 31 */
  ...
  /* If Pages 24 to 31 are not write protected, perform erase and program operations
     Else nothing */
  if (ProtectedPages != 0x00)
  {
