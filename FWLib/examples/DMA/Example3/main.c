...
u8 Tx_Idx = 0, Rx_Idx = 0, SPI1_CRC_Value = 0, SPI2_CRC_Value = 0;
...
int main(void)
{
  ...
  /* Enable DMA Channel5, Channel4, Channel3 and Channel2 */
  ...
  SPI1_CRC_Value = SPI_ReceiveData(SPI1);

  /* Read SPI2 CRC value */  
  while(SPI_GetFlagStatus(SPI2, SPI_FLAG_RXNE) == RESET);
  SPI2_CRC_Value = SPI_ReceiveData(SPI2);

  /* Check if the transmitted and received data are equal */
  TransferStatus1 = Buffercmp(SPI1_Buffer_Tx, SPI2_Buffer_Rx, BufferSize);
  TransferStatus2 = Buffercmp(SPI2_Buffer_Tx, SPI1_Buffer_Rx, BufferSize);
