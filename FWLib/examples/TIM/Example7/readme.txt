...
* Version            : V1.0
* Date               : 10/08/2007
* Description        : Description of the TIM Example7.
********************************************************************************
...
The TIM2 is configured as the following: 
...
====================
 - Connect the external signal to measure to the TIM2_CH2 pin (PA.01)
- Connect the TIM2_CH1 (PA.00) pin to an oscilloscope to show the waveform.
