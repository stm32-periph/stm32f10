...
* Version            : V1.0
* Date               : 10/08/2007
* Description        : TIM Example 8 Main program body
********************************************************************************
...
int main(void)
{
  ...
  /* Timers synchronisation in parallel mode ----------------------------
     ...
     The TIM4 is running:
     - At (TIM2 frequency)/ (TIM4 period + 1) = 52.250 KHz and a duty cycle
  ...
  TIM_OCInitStructure.TIM_Pulse = 63;  
...
void GPIO_Configuration(void)
{
  ...
  /* GPIOA Configuration: PA0(TIM2 CH1) and PA6(TIM3 CH1) */
