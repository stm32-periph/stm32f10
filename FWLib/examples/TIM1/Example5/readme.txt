...
* Version            : V1.0
* Date               : 10/08/2007
* Description        : Description of the TIM1 Example5.
********************************************************************************
...
This example provides a description of how to use DMA  with TIM1 Update
request to transfer Data from memory to TIM1 Capture Compare Register3.
...
- TIM1 CH3  (PA.10)
- TIM1 CH3N (PB.15 )
to an oscilloscope to show the waveforms.
