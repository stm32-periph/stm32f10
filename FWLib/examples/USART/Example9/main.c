...
u8 TxBuffer1[] = "USART Example 9: USART1 -> USART2 using HalfDuplex mode";
u8 TxBuffer2[] = "USART Example 9: USART2 -> USART1 using HalfDuplex mode";
...
void GPIO_Configuration(void)
{
  ...
  /* Configure USART2 Tx (PD.05) as alternate function open-drain */
