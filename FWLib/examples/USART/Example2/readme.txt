...
* Version            : V1.0
* Date               : 10/08/2007
* Description        : Description of the USART Example2.
********************************************************************************
...
Example description
===================
This example provides a description of how  to use the USART1 interrupts to 
communicate with the hyperterminal.
The USART1 sends a predefined buffer to the hyperterminal and still waiting 
