...
* Version            : V1.0
* Date               : 10/08/2007
* Description        : Description of the USART Example8.
********************************************************************************
...
First, the USART1 sends data from TxBuffer1 buffer to SPI1 using TXE flag.
...
Then, the SPI1 sends data from TxBuffer2 buffer to USART1 using TXE flag.
