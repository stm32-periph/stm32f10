...
u8 TxBuffer1[] = "USART Example 8: USART1 -> SPI1 using TXE and RXNE Flags";
u8 TxBuffer2[] = "USART Example 8: SPI1 -> USART1 using TXE and RXNE Flags";
...
/* USART1 configuration ------------------------------------------------------*/
  ...
  */
  ...
  while(NbrOfDataToRead2--)
  {
    ...
    RxBuffer2[RxCounter2++] = SPI_ReceiveData(SPI1);
  }
  ...
  while(NbrOfDataToRead1--)
  {
    ...
    SPI_SendData(SPI1, TxBuffer2[TxCounter2++]);
...
void GPIO_Configuration(void)
{
  ...
  /* Configure USART1 Tx (PA9) and USART1 CK(PA8) as alternate function push-pull */
