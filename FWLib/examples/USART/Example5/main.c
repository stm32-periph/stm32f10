...
u8 TxBuffer1[] = "USART Example 5: USART1 -> USART2 using DMA";
u8 TxBuffer2[] = "USART Example 5: USART2 -> USART1 using DMA";
...
void DMA_Configuration(void)
{
  ...
  /* DMA Channel5 (triggered by USART1 Rx event) Config */
