...
* Version            : V1.0
* Date               : 10/08/2007
* Description        : Description of the USART Example6.
********************************************************************************
...
Then, the DMA transfers data from TxBuffer1 buffer to USART1 Transmit data register,
then this data is sent to USART2. Data received by USART2 is transferred using 
Receive interrupt and stored in RxBuffer2 then compared with the sent ones and 
